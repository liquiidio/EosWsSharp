...
namespace EosWsSharp.Responses.Types
{
    ...
    public class HeadInfo : IDfuseResponseData
    {
        ...
        public long HeadBlockNum { get; internal set; }

        [JsonProperty("head_block_id")]
        public string HeadBlockId { get; internal set; }

        [JsonProperty("head_block_time")]
        public DateTimeOffset HeadBlockTime { get; internal set; }

        [JsonProperty("head_block_producer")]
        public string HeadBlockProducer { get; internal set; }
    }
}
